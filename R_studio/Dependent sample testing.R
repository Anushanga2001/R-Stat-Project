...
# is depend on the production quality of the line (before implementing the new producation process).
...
t.test(before_process, after_process, alternative = "greater", paired = TRUE)
...
t.test(after_process, before_process, alternative = "greater", paired = TRUE)
